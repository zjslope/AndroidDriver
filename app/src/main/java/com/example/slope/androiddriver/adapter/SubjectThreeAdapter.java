 ...
 */
public class SubjectThreeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private String[] title;
    private int[] image;
    private OnItemClickListener mItemClickListener;

    public SubjectThreeAdapter(Context context, String[] title, int[] image) {
